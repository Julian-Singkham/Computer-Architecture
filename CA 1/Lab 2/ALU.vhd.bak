...
entity ARMv4_ALU is
	...
	F: 	inout std_logic_vector(31 downto 0);--Output
...
--====================Outputs======================
	...
	with ALUS select V <= 
		(INTA(31) and INTB(31) and (NOT INTF(31))) or 
		((NOT INTA(31)) and (NOT INTB(31)) and INTF(31)) when B"000", -- during add, two +=-, two -=+
		(INTA(31) and (NOT INTB(31)) and (NOT INTF(31))) or 
		((NOT INTA(31)) and INTB(31) and INTF(31)) when B"001", -- during sub, --+=+, +-1=-
		'0' when others;
	...
	--Zero:
	z <= '1' when INTF(31 downto 0)=X"0" else '0';
	F <= INTF(31 downto 0);
